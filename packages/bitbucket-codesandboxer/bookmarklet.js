...
(() => {
  ...
  let url = `https://bitbucket-codesandboxer.netlify.com/?host=${parsed.host}&repoOwner=${parsed.repoOwner}&repoSlug=${parsed.repoSlug}&commit=${parsed.commit}&file=${encodedFile}`;
